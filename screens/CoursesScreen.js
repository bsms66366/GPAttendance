    ...
    <View style={styles.v_container}>
      ...
      <View style={{flex: 1, flexDirection: 'row', flexWrap:1}}>
        ...
        <View style={styles.BoxBorder(height, width)}>
          <TouchableOpacity onPress = {() => WebBrowser.openBrowserAsync('https://www.bsms.ac.uk/postgraduate/index.aspx') }>
        ...
        <View style={styles.BoxBorder(height, width)}>
        <TouchableOpacity onPress = {() => WebBrowser.openBrowserAsync('https://www.bsms.ac.uk/postgraduate/continuing-professional-development/short-courses-and-workshops/clinical-workshops.aspx#anatomytraining') }>
          <Image source={require('../assets/images/interfaceIcons_Artboard22.png')} style ={styles.IconStyle} />  
          <Button title="CPD" style={styles.titleText}/>
           </TouchableOpacity>
          </View>
        ...
        <TouchableOpacity onPress = {() => WebBrowser.openBrowserAsync('https://tools.brighton.ac.uk/medical-school/AnatomyInterface/admin/postGrad.php') }>
          <Image source={require('../assets/images/interfaceIcons_Artboard20.png')} style ={styles.IconStyle} />
            <Button title="Post Graduate" style={styles.titleText}/>
        </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity onPress = {() => WebBrowser.openBrowserAsync('https://www.bsms.ac.uk/postgraduate/index.aspx') }>
          <Image source={require('../assets/images/interfaceIcons_Artboard22.png')} style ={styles.IconStyle} />
            <Button title="Speciality Training" style={styles.titleText}/>
        </TouchableOpacity>
        </View>
